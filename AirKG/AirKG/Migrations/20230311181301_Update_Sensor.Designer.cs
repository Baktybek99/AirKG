...
{
    [DbContext(typeof(AirKGDbContext))]
    [Migration("20230311181301_Update_Sensor")]
    partial class Update_Sensor
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AirKG.Entity.AirData", b =>
                {
                    ...
                    b.Property<int>("DegreeOfQuality")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AirKG.Entity.User", b =>
                {
            ...
            modelBuilder.Entity("AirKG.Entity.Sensor", b =>
                {
                    b.HasOne("AirKG.Entity.District", "District")
                        .WithMany("Sensors")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("AirKG.Entity.User", null)
                        .WithMany()
